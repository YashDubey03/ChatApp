      ...
      <div className="flex flex-col h-[calc(100%-120px)] overflow-y-scroll p-3 pb-6">
        ...
        {messages.map((msg, index) => {
          ...
          return (
            ...
            >
              {/* LEFT SIDE AVATAR (only for received messages) */}
              {!isMe && (
                <img
                  src={selectedUser?.profilePic || assets.avatar_icon}
                  alt=""
              ...
              {msg?.image ? (
                <img
                  src={msg?.image}
                  alt=""
                  className={`max-w-60 border rounded-lg ${
                    isMe ? "rounded-br-none" : "rounded-bl-none"
                  }`}
                />
              ) : (
                <p
                  className={`p-2 max-w-60 text-sm rounded-lg break-all text-white ${
                    isMe
              ...
              {/* RIGHT SIDE AVATAR (only for sent messages) */}
              {isMe && (
                <img
